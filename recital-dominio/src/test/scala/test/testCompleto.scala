...
class testCompleto extends AssertionsForJUnit {
  ...
  def testNocheNoTieneDescuentoApropiado {
    ...
    try {
      var entrada = new Entrada(sectorA, noche1, jubilado2, 10, 2, "Pepe", "Abasto")
  ...
  def precioEntradaMayorCorrecto {
    var entrada = new Entrada(sectorA, noche1, mayor, 10, 2, "Pepe", "Abasto")
    var entrada2 = new Entrada(sectorA, noche1, mayor, 15, 2, "Pepe", "Abasto")
    var entrada3 = new Entrada(sectorA, noche2, mayor, 10, 2, "Pepe", "Abasto")
    var entrada4 = new Entrada(sectorA, noche2, mayor, 15, 2, "Pepe", "Abasto")
  ...
  def precioEntradaMenorCorrecto {
    var entrada = new Entrada(sectorA, noche1, menor, 10, 2, "Pepe", "Abasto")
    var entrada2 = new Entrada(sectorA, noche1, menor, 15, 2, "Pepe", "Abasto")
    var entrada3 = new Entrada(sectorA, noche2, menor, 10, 2, "Pepe", "Abasto")
    var entrada4 = new Entrada(sectorA, noche2, menor, 15, 2, "Pepe", "Abasto")
  ...
  def precioEntradaJubiladoCorrecto {
    var entrada = new Entrada(sectorA, noche1, jubilado, 10, 2, "Pepe", "Abasto")
    var entrada2 = new Entrada(sectorA, noche1, jubilado, 15, 2, "Pepe", "Abasto")
    var entrada3 = new Entrada(sectorA, noche2, jubilado, 10, 2, "Pepe", "Abasto")
    var entrada4 = new Entrada(sectorA, noche2, jubilado, 15, 2, "Pepe", "Abasto")
  ...
  def venderEntradaCorrectamente {
	var entrada = new Entrada(sectorA, noche1, menor, 10, 2, "Pepe", "Abasto")
	var entrada2 = new Entrada(sectorA, noche1, menor, 10, 3, "Pepe", "Abasto")
  ...
  def venderComboEntradaCorrectamente {
	var entrada1 = new Entrada(sectorA, noche1, menor, 10, 2, "Pepe", "Abasto")
	var entrada2 = new Entrada(sectorA, noche1, menor, 10, 3, "Pepe", "Abasto")
	var entrada3 = new Entrada(sectorA, noche1, menor, 10, 4, "Pepe", "Abasto")
	var entrada4 = new Entrada(sectorA, noche1, menor, 10, 5, "Pepe", "Abasto")
  ...
  def testInstancioUnaEntradaConUbicacionIncorrecta {
	//Pruebo fila erronea 
    try {
      var entrada1 = new Entrada(sectorA, noche1, menor, 60, 2, "Pepe", "Abasto")
    ...
    try {
      var entrada2 = new Entrada(sectorA, noche1, menor, 60, 100, "Pepe", "Abasto")
    ...
    try {
      var entrada3 = new Entrada(sectorA, noche1, menor, 10, 100, "Pepe", "Abasto")
